...
public void AggFavoritosAction(ActionEvent event) {
    Producto producto = new Producto("Sulfato Ferroso Jarabe", "Frasco Jarabe Sulfato Ferroso 120ml ", 5000, "Jarabe");
    ...
    public void AggCarritoAction(ActionEvent event) {
        Producto producto = new Producto("Sulfato Ferroso Jarabe", "Frasco Jarabe Sulfato Ferroso 120ml ", 5.000, "Jarabe");
