...
public class VitaCController implements Initializable {

    @FXML private Button BtnHome, btnMenu, btnAggFavoritos, btnAggCarrito;
    ...
    public void AggFavoritosAction(ActionEvent event) {
        Producto producto = new Producto("Vita C", "Caja x100 Tabletas Masticables de Vitamina C", 22000, "Tableta");
