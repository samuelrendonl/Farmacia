 ...
 * @author samue
 */
public class LoratadinaController implements Initializable {
...
public void AggFavoritosAction(ActionEvent event) {
    Producto producto = new Producto("Loratadina", "Frasco x100mL", 7000, "Jarabe");
    ...
    public void AggCarritoAction(ActionEvent event) {
        Producto producto = new Producto("Loratadina", "Frasco x100mL", 7_000, "Jarabe");
